  ...
  return (
    <div className="container-custom px-4 py-20">
      <div className="max-w-lg mx-auto bg-surface-2 rounded-3xl shadow-card p-8 md:p-12 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-8"><Link to={`/order/${orderId}/track`} className="btn-primary">Track Order</Link><Link to="/home" className="btn-secondary">Continue Shopping</Link><Link to="/profile/orders" className="btn-ghost">View Orders</Link></div>
      </div>
    </div>
  );
};
